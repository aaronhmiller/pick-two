...
<body>
    <div class="container">
        ...
        <div class="toggle-item" id="item-good">
            ...
            <label class="toggle-switch">
                <input type="checkbox" id="toggle-good" data-name="good">
    ...
    <script>
        const toggles = {
            good: { 
                el: document.getElementById('toggle-good'), 
                label: document.getElementById('label-good'), 
                item: document.getElementById('item-good'),
                positive: 'Good', 
                negative: 'Bad' 
            },
            fast: { 
